...
public class ConsecutiveNumbers {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // vasiot kod ovde
        System.out.println(isplustwo(tree.root));


    }
//
    public static boolean isplustwo(BNode<Integer> n) {
        Stack<BNode<Integer>> stack = new Stack<BNode<Integer>>();
        stack.push(n);
        while (!stack.isEmpty()) {
            ...
            if (temp.info+2!=stack.peek().info){
                return false;
            }
        }
        return true;
